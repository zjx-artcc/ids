...
export default function EmergencyChecklist() {
    return (
        <>
            ...
            <Typography variant="h6" color="red" sx={{textDecoration: 'underline',}}>!! Do not close this window or
                switch to a different IDS tab !!</Typography>
            <Typography>To access other IDS features, open a new IDS tab. If you leave this checklist, all changes will
                be lost.</Typography>
            <TextField multiline label="NOTES (press Enter for new line)" color="info" fullWidth/>
            <FormGroup>
                <Typography variant="h6">Start assistance as soon as enough information has been obtained upon which to
                    act. Information requirements will vary, depending on the existing situation. Minimum required
                    information for inflight emergencies is:</Typography>
                ...
                <br/>
                <Typography variant="h6">After initiating action, obtain the following items or any other pertinent
                    information from the pilot or aircraft operator, as necessary:</Typography>
